...
#### The SLIP is the code of the published paper "SLIP: Soft Label Mechanism and Key-Extraction-Guided CoT-based Defense Against Instruction Backdoor in APIs" on the 2026-ACL-findings [paper link](https://arxiv.org/abs/2508.06153).
#### The BeDKD is the code of the accepted paper "BeDKD: Backdoor Defense based on Directional Mapping Module and Adversarial Knowledge Distillation" on the 2026-AAAI [paper link](https://arxiv.org/abs/2508.01595).
